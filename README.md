...
synthetic or publicly available data to demonstrate methodology while
preserving confidentiality - standard practice in regulated environments.

Technologies: Python, SQL, SQLite, pandas, scikit-learn, matplotlib,
seaborn, logistic regression, StandardScaler
